...
import { doc, writeBatch, collection, serverTimestamp, getDoc, setDoc } from "https://www.gstatic.com/firebasejs/9.6.5/firebase-firestore.js";
import {
...
async function registerAdmin() {
    ...
    try {
        ...
        // Set custom claims for admin role (this would typically be done server-side)
...
document
    ...
    .addEventListener("click", async function () {
        try {
            ...
            console.log("Google admin registration successful:", user);
